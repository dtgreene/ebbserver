...
// CONFIGURATION ===============================================================
const cncserver = {
  // Master object for holding/passing stuff!
...
cncserver.actualPen = Object.assign({}, cncserver.pen);
...
cncserver.settings.loadGlobalConfig(function standaloneOrModuleInit() {
  ...
  if (!module.parent) {
    ...
    // Export the module's useful API functions! ======================
        ...
        cncserver.ipc.initServer(
          ...
          function () {
            ...
            cncserver.serial.connect({
              ...
              disconnect: function () {
                // Callback for serial disconnect
                cncserver.serial.localTrigger('serialClose');
